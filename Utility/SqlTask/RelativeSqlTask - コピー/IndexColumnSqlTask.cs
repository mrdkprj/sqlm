...
{
    public class IndexColumnSqlTask : DbObjectMetaDataSqlTask, IChildSqlTask
    {
        public IndexColumnSqlTask(ISynchronizeInvoke invoker, ISqlService service) : base(invoker, service) { }
