...
{
    public class TableConstraintSqlTask : DbObjectMetaDataSqlTask, IChildSqlTask
    {
        public TableConstraintSqlTask(ISynchronizeInvoke invoker, ISqlService service) : base(invoker, service) { }
