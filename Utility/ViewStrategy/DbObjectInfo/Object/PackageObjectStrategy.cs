...
{
    class PackageObjectStrategy : IDbObjectStrategy
    {
        ...
        static PackageObjectStrategy _instance = new PackageObjectStrategy();
        static PackageObjectStrategy() { }
        private PackageObjectStrategy()
        {
            _child = new GeneralPropertyStrategy(this, null);
        }
        public static PackageObjectStrategy Instance
        {
        ...
        public DbObjectType ObjectType { get { return DbObjectType.Package; } }
        ...
        public IDbCommandBuilder CommandBuilder
        {
            get
            {
                _builder.CreateCommand(_dataAccess.SqlLibrary.SqlPackageObjectInfo,
                    DbObjectDbCommandParameters.GetObjectParemeterNames(DbObjectType.Package),
                    GetParamValue());
                return _builder;
            }
        }
