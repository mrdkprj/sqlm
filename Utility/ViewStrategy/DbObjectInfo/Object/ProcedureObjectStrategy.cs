...
{
    class ProcedureObjectStrategy : IDbObjectStrategy
    {
        ...
        static ProcedureObjectStrategy _instance = new ProcedureObjectStrategy();
        static ProcedureObjectStrategy() { }
        private ProcedureObjectStrategy()
        {
            _child = new GeneralPropertyStrategy(this, null);
        }
        public static ProcedureObjectStrategy Instance
        {
        ...
        public DbObjectType ObjectType { get { return DbObjectType.Procedure; } }
        ...
        public IDbCommandBuilder CommandBuilder
        {
            get
            {
                _builder.CreateCommand(_dataAccess.SqlLibrary.SqlProcedureObjectInfo,
                    DbObjectDbCommandParameters.GetObjectParemeterNames(DbObjectType.Procedure),
                    GetParamValue());
                return _builder;
            }
        }
