...
{
    class SequenceObjectStrategy : IDbObjectStrategy
    {
        ...
        static SequenceObjectStrategy _instance = new SequenceObjectStrategy();
        static SequenceObjectStrategy() { }
        private SequenceObjectStrategy()
        {
            _child = new GeneralPropertyStrategy(this, null);
        }
        public static SequenceObjectStrategy Instance
        {
        ...
        public DbObjectType ObjectType { get { return DbObjectType.Sequence; } }
        ...
        public IDbCommandBuilder CommandBuilder
        {
            get
            {
                _builder.CreateCommand(_dataAccess.SqlLibrary.SqlSequenceObjectInfo,
                    DbObjectDbCommandParameters.GetObjectParemeterNames(DbObjectType.Sequence),
                    GetParamValue());
                return _builder;
            }
        }
