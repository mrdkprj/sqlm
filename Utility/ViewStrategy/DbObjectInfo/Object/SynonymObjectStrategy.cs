...
{
    class SynonymObjectStrategy : IDbObjectStrategy
    {
        ...
        static SynonymObjectStrategy _instance = new SynonymObjectStrategy();
        static SynonymObjectStrategy() { }
        private SynonymObjectStrategy()
        {
            _child = new GeneralPropertyStrategy(this, null);
        }
        public static SynonymObjectStrategy Instance
        {
        ...
        public DbObjectType ObjectType { get { return DbObjectType.Synonym; } }
        ...
        public IDbCommandBuilder CommandBuilder
        {
            get
            {
                _builder.CreateCommand(_dataAccess.SqlLibrary.SqlSynonymObjectInfo,
                    DbObjectDbCommandParameters.GetObjectParemeterNames(DbObjectType.Synonym),
                    GetParamValue());
                return _builder;
            }
        }
