...
{
    public class TableObjectStrategy : IDbObjectStrategy
    {
        ...
        static TableObjectStrategy _instance = new TableObjectStrategy();
        static TableObjectStrategy() { }
        private TableObjectStrategy()
        {
            _child =
                new TableColumnPropertyStrategy(this,
                    new TableIndexPropertyStrategy(this,
                        new TableConstraintPropertyStrategy(this,
                            new GeneralPropertyStrategy(this, null
                            ))));
        }
        public static TableObjectStrategy Instance
        {
        ...
        public DbObjectType ObjectType { get { return DbObjectType.Table; } }
        ...
        public bool SupportExport { get { return true; } }

        public bool SupportImport { get { return true; } }

        public IDbCommandBuilder CommandBuilder
        {
            get
            {
                _builder.CreateCommand(_dataAccess.SqlLibrary.SqlTableObjectInfo,
                    DbObjectDbCommandParameters.GetObjectParemeterNames(DbObjectType.Table),
                    GetParamValue());
                return _builder;
            }
        }
