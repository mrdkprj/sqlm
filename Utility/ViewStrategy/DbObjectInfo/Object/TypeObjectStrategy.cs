...
{
    class TypeObjectStrategy : IDbObjectStrategy
    {
        ...
        static TypeObjectStrategy _instance = new TypeObjectStrategy();
        static TypeObjectStrategy() { }
        private TypeObjectStrategy()
        {
            _child = new GeneralPropertyStrategy(this, null);
        }
        public static TypeObjectStrategy Instance
        {
        ...
        public DbObjectType ObjectType { get { return DbObjectType.Type; } }
        ...
        public IDbCommandBuilder CommandBuilder
        {
            get
            {
                _builder.CreateCommand(_dataAccess.SqlLibrary.SqlTypeObjectInfo,
                    DbObjectDbCommandParameters.GetObjectParemeterNames(DbObjectType.Type),
                    GetParamValue());
                return _builder;
            }
        }
