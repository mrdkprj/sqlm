...
{
    public class GeneralPropertyStrategy : IDbObjectStrategy
    {
        ...
        public GeneralPropertyStrategy(IDbObjectStrategy parent, IDbObjectStrategy child)
        {
            _parent = parent;
            _child = child;
        }
        ...
        public IDbCommandBuilder CommandBuilder
        {
            get
            {
                _builder.CreateCommand(DbObjectDbCommandParameters.GetGeneralPropertySql(_parent.ObjectType),
        ...
        public int NameColumnIndex { get { return 1; } }
